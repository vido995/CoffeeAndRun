                            ...
                            <div className={"left-hero-tilt " + "left-hero-tilt-" + this.state.customerState}>
                                <div className="side-container">
                                    ...
                                    <div class={"collapsed " + (this.state.customerState === "collapsed" ? "active" : "")}>
                                        <h2>Customers</h2>
                                        <span class="round-filled-icon" onClick={() => this.setState({customerState: "initial", bussinessState: "initial"})}>&rarr;</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className={"right-hero " + "right-hero-" + this.state.bussinessState}>
                            <div className={"right-hero-tilt " + "right-hero-tilt-" + this.state.bussinessState}>
                                <div className="side-container">
                                    ...
                                    <div class={"collapsed " + (this.state.bussinessState === "collapsed" ? "active" : "")}>
                                        <h2>Bussiness</h2>
                                        <span class="round-filled-icon" onClick={() => this.setState({customerState: "initial", bussinessState: "initial"})}>&larr;</span>
                                    </div>
                                </div>
                            </div>
                        </div>
